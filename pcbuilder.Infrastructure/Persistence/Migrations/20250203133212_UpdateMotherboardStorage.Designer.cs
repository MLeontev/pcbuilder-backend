...
namespace pcbuilder.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250203133212_UpdateMotherboardStorage")]
    partial class UpdateMotherboardStorage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("pcbuilder.Domain.Models.Motherboards.MotherboardStorage", b =>
                {
                    ...
                    b.HasKey("MotherboardId", "StorageFormFactorId");
            ...
            modelBuilder.Entity("pcbuilder.Domain.Models.Motherboards.MotherboardStorageInterface", b =>
                {
                    ...
                    b.Property<int>("MotherboardStorageSlotMotherboardId")
                        .HasColumnType("integer");

                    b.Property<int>("MotherboardStorageSlotStorageFormFactorId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MotherboardStorageSlotMotherboardId", "MotherboardStorageSlotStorageFormFactorId");
            ...
            modelBuilder.Entity("pcbuilder.Domain.Models.Motherboards.MotherboardStorageInterface", b =>
                {
                    ...
                    b.HasOne("pcbuilder.Domain.Models.Motherboards.MotherboardStorage", "MotherboardStorageSlot")
                        ...
                        .HasForeignKey("MotherboardStorageSlotMotherboardId", "MotherboardStorageSlotStorageFormFactorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
